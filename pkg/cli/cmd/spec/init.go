...
func (opts *InitSubCommand) complete(input cli.Input) error {
	...
	// Create spec dir
	fmt.Printf("Creating spec directory '%v'\n", specDir)
...
func (opts *InitSubCommand) run(input cli.Input) error {
	...
	config := filepath.Join(specDir, "kubefaas-deployment-config.yaml")
...
// kubefaas-config.yaml in specDir.
func writeDeploymentConfig(file string, dc *spectypes.DeploymentConfig) error {
	...
	msg := []byte("# This file is generated by the 'kubefaas spec init' command.\n" +
		"# See the README in this directory for background and usage information.\n" +
		"# Do not edit the UID below: that will break 'kubefaas spec apply'\n")
