...
do
    ...
    do
        ...
        kubefaas env create --name python --version 2 --image kubefaas/python-env --period 5 --mincpu 300 --maxcpu 300 --minmemory 256 --maxmemory 256
        ...
        kubefaas pkg delete --name ${pkgName}
        rm -rf pkg.zip pkg
