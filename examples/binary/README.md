...
kubefaas function create --name hello --env binary-env --code hello.sh
...
```bash
# Upload the function to kubefaas
kubefaas function create --name echo --env binary-env --code echo.sh
...
```bash
# Upload the function to kubefaas
kubefaas function create --name headers --env binary-env --code headers.sh
